...
if #available(iOS 9, *) {
  ...
  let headerStackView = UIStackView(arrangedSubviews: [iconImageView, metaDataStackView])
  ...
  constraints += NSLayoutConstraint.constraintsWithVisualFormat("V:|-10-[headerStackView]-10-|", options: [], metrics: nil, views: views)
